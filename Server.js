  ...
  .on("end", function() {
    ...
    connection.connect(error => {
        if (error) {
            ...
            let query = "INSERT INTO lecture (강의구분,수강학년,과목코드,과목명,교수명,수업시간,학점,단과대학,학과,수강인원,수강정원,강의평점) VALUES ? ;";
...
app.get('/', function(req, res) { 
    ...
    major[2] = ["공과대학", "건축공학과", "건축학과", "공업화학과", "기계공학부", "도시공학과", "신소재공학과", "안전공학과", "테크노산업공학과", "토목공학부", "화학공학과", "환경공학과"];
    major[3] = ["농업생명환경대학", "농업경제학과", "목재종이과학과", "바이오시스템공학과", "산림학과", "식물의학과", "식물자원학과", "식품생명공학과", "원예과학과", "지역건설공학과", "축산학과", "특용식물학과", "환경생명화학과"];
    major[4] = ["바이오헬스공유대학", "방사광융합학과", "제약바이오학과", "천연물소재학과", "화장품산업학과"];
    major[5] = ["사범대학", "교육학과", "국어교육과", "물리교육과", "사회교육과", "생물교육과", "수학교육과", "역사교육과", "영어교육과", "윤리교육과", "지구과학교육과", "지리교육과", "체육교육과", "화학교육과"];
    major[6] = ["사회과학대학", "경제학과", "사회학과", "심리학과", "정치외교학과", "행정학과"];
    major[7] = ["생활과학대학", "소비자학과", "식품영양학과", "아동복지학과", "의류학과", "주거환경학과"];
    major[8] = ["수의과대학", "수의예과", "수의학과"];
    major[9] = ["약학대학", "약학과", "제약학과"];
    major[10] = ["연계전공", "공통과학교육전공", "통합과학교육전공", "통합사회교육전공"];
    major[11] = ["융합전공", "과학커뮤니케이션", "국제개발협력과거버넌스", "노인복지", "농촌관광개발", "문화유산의공간정보학", "문화콘텐츠", "박물관전문인력", "번역출판전공", "벤처비즈니스전공", "보안컨설팅전공", "빅데이터", "사회적기업", "스마트자동차공학", "언론정보전공", "영한통역", "위기관리", "해외농업개발ㆍ협력전공", "지식재산스마트융합"];
    major[12] = ["융합학과군", "디자인학과", "조형예술학과"];
    major[13] = ["의과대학", "간호학과", "의예과", "의학과"];
    major[14] = ["인문대학", "고고미술사학과", "국어국문학과", "독일언어문화학과", "러시아언어문화학과", "사학과", "영어영문학과", "중어중문학과", "철학과", "프랑스언어문화학과"];
    major[15] = ["자연과학대학", "물리학과", "미생물학과", "생명과학과", "생화학과", "수학과", "정보통계학과", "지구환경과학과", "천문우주학과", "화학과"];
    major[16] = ["전자정보대학", "SW융합부전공", "소프트웨어학과", "소프트웨어학부", "전기공학부", "전자공학부", "정보통신공학부", "지능로봇공학과", "컴퓨터공학과"];
